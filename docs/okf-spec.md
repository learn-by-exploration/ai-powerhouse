...
> Vendored reference copy. Source: https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
> See [[okf-uses]] for how this repo could adopt the format.
